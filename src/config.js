...
//export const CALLBACK_URL = encodeURIComponent("http://127.0.0.1:5500/dist/");

export const NODE_KEY = "1Solon1";
export const NODE_URL = "https://idenanode.com/";
// export const NODE_URL = "http://127.0.0.1:8100";
// export const NODE_KEY = "123";

export const AUTH_WORKER_URL = "https://auth.idenanode.com";
